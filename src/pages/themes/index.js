      ...
      <div className="w-full flex flex-col mt-4 gap-4 max-w-96 border p-4 bg-background rounded-lg">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button type="button" variant={"default"} className="h-12 bg-secondary hover:bg-secondary-foreground" onClick={() => handleSubmit(marketName, setMarketName)}>
              Submit
            </Button>
          </div>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button type="button" variant={"default"} className="h-12 bg-secondary hover:bg-secondary-foreground" onClick={() => handleSubmit(baseMint, setBaseMint)}>
              Submit
            </Button>
          </div>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button type="button" variant={"default"} className="h-12 bg-secondary hover:bg-secondary-foreground" onClick={() => handleSubmit(quoteMint, setQuoteMint)}>
              Submit
            </Button>
          </div>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button type="button" variant={"default"} className="h-12 bg-secondary hover:bg-secondary-foreground" onClick={() => handleSubmit(minOrderSize, setMinOrderSize)}>
              Submit
            </Button>
          </div>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button type="button" variant={"default"} className="h-12 bg-secondary hover:bg-secondary-foreground" onClick={handleFileUpload}>
              Upload
            </Button>
          </div>
        </div>
